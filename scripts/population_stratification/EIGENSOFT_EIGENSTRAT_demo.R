...
sink("EIGENSOFT_log.Rout", split = TRUE)
for (i in 1:N_SIMULATIONS) {
  ...
  X_norm_reg0 <- regressMatrix(X_data, k = 0)
  ...
  # Run EIGENSTRAT with regression (suggested by PPR2006)
